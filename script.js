document.addEventListener('DOMContentLoaded', () => {
    ...
    let galleryInterval;
    let visualHeartsInterval; // Interval untuk hati terbang
    ...
    playButton.addEventListener('click', () => {
        ...
        // Mulai interval hati terbang dan jangan pernah hentikan
        if (!visualHeartsInterval) {
    ...
    backToMenuButton.addEventListener('click', () => {
        ...
        greetingSection.style.display = 'flex';
        currentSlideIndex = 0;
        // Biarkan hati terbang tetap berjalan
    });
    ...
    function showSlide(index) {
        ...
        // Picu animasi love burst setiap kali slide aktif
        ...
        // Tampilkan caption hanya di slide pertama
        if (index === 0) {
    ...
    // Fungsi ini membuat hati terbang di background (di dalam .visual-wrapper)
